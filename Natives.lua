...
ATTACH_ENTITY_TO_ENTIY = function(e1, e2, x, y, z) Natives.InvokeVoid(0x6B9BBD38AB0796DF, e1, e2, 0, x, y, z, 0.0, 0.0, 0.0, true, true, true, false, 0, true, 0) end
...
SET_VEH_COLOURS = function(veh, c1, c2) Natives.InvokeVoid(0x4F1D4BE3A7F24601, veh, c1, c2) end
...
SHOOT_AT_ENTITY = function(ped, target, duration) Natives.InvokeVoid(0x08DA95E8298AE772, ped, target, duration, Utils.Joaat("FIRING_PATTERN_FULL_AUTO")) end
...
BLOCK_ALL_EVENTS = function(ped) Natives.InvokeVoid(0x9F8AA94D6D97DBF4, ped, true) end

SET_COMBAT_ABILITY = function(ped, lvl) Natives.InvokeVoid(0xC7622C0D36B2FDA8, ped, lvl) end

SET_COMBAT_ATTRIBUTES = function(ped, id, bool) Natives.InvokeVoid(0x9F7794730795E019, ped, id, bool) end

SET_ACCURACY = function(ped, lvl) Natives.InvokeVoid(0x7AEFB85C1D49DEB6, ped, lvl) end
...
OPEN_SEQUENCE = function(ptr) Natives.InvokeVoid(0xE8854A4326B9E12B, ptr) end

CLOSE_SEQUENCE = function(id, ptr) Natives.InvokeVoid(0x39E72BC99E6360CB, id) Natives.InvokeVoid(0x3841422E9C488D8C, ptr) end

PERFORM_SEQUENCE = function(ped, id) Natives.InvokeVoid(0x5ABA3986D90D8A3B, ped, id) end
...
SET_INFINITE_AMMO = function(ped, bool, hash) Natives.InvokeVoid(0x3EDCB0505123623B, ped, bool, hash) end

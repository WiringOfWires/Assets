...
SET_PED_INTO_VEHICLE = function(ped, veh) Natives.InvokeVoid(0xF75B0D629E1C063D, ped, veh, -1) end
...
MODIFY_VEHICLE_SPEED = function(veh, speed) Natives.InvokeVoid(0x93A3996368C94158, veh, speed) end
...
SHOOT_BULLET = function(x1, y1, z1, x2, y2, z2, dmg, weapon, owner) Natives.InvokeVoid(0x867654CBC7606F2C, x1, y1, z1, x2, y2, z2, dmg, true, weapon, owner, true, false, 1000.0) end
